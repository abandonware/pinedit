...
void CommandAddSelect::execute(const CommandContext & context) {
  EM_CERR("CommandAddSelect::execute ");
  ...
  default: EM_CERR("CommandAddSelect::execute unknown type");
  }
  ...
  EM_CERR("CommandAddSelect::execute " << context.x1 <<" "<< context.y1 <<" "<< context.z1 << 
