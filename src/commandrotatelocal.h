/***************************************************************************
                          commandrotatelocal.h  -  description
                             -------------------
...
#ifndef COMMANDROTATELOCAL_H
#define COMMANDROTATELOCAL_H
...
class CommandRotateLocal : public Command  {
 public:
	CommandRotateLocal(PinEditDoc * doc);
	~CommandRotateLocal();
	Command * build();
	void undo();
	void clearObjects();
